...
return [
	...
	"nav_assistance" => "Insurances",
	"nav_about_us" => "About us",

	"nav_insurance_long_stay_student" => "Student insurance",
	"nav_insurance_multi_trip" => "Multi trip insurance",
	"nav_insurance_technology" => "Belongings and IT insurance",
