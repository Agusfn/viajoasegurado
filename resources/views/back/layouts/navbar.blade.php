			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a href="{{ url(config('app.url')) }}" data-toggle="tooltip" data-placement="bottom" title="Ir a viajoasegurado.com" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
						</li>						
						<li class="dropdown">
