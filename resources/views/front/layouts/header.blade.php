                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a class="logo" href="{{ url('') }}">
                                <img src="{{ asset('front/img/logo-invert.png') }}" alt="Image Alternative text" title="Image Title" />
                            </a>
                        </div>
                                ...
                                <ul class="top-user-area-list list list-horizontal list-border">
                                    <li class="top-user-area-avatar">
                                        <a href="user-profile.html">
                                            <img class="origin round" src="{{ asset('front/img/40x40.png') }}" alt="Image Alternative text" title="AMaze" />Hi, John</a>
                                    </li>
                                    ...
                                    <li class="top-user-area-lang nav-drop">
                                        <a href="#">
                                            <img src="{{ asset('front/img/flags/32/uk.png') }}" alt="Image Alternative text" title="Image Title" />ENG<i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i>
                                        </a>
                                        <ul class="list nav-drop-menu">
                                            <li>
                                                <a title="German" href="#">
                                                    <img src="{{ asset('front/img/flags/32/de.png') }}" alt="Image Alternative text" title="Image Title" /><span class="right">GER</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Japanise" href="#">
                                                    <img src="{{ asset('front/img/flags/32/jp.png') }}" alt="Image Alternative text" title="Image Title" /><span class="right">JAP</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Italian" href="#">
                                                    <img src="{{ asset('front/img/flags/32/it.png') }}" alt="Image Alternative text" title="Image Title" /><span class="right">ITA</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="French" href="#">
                                                    <img src="{{ asset('front/img/flags/32/fr.png') }}" alt="Image Alternative text" title="Image Title" /><span class="right">FRE</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Russian" href="#">
                                                    <img src="{{ asset('front/img/flags/32/ru.png') }}" alt="Image Alternative text" title="Image Title" /><span class="right">RUS</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Korean" href="#">
                                                    <img src="{{ asset('front/img/flags/32/kr.png') }}" alt="Image Alternative text" title="Image Title" /><span class="right">KOR</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
