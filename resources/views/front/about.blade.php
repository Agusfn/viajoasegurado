...
@section('content')
        ...
        <div class="bg-holder">
            <div class="bg-parallax" style="background-image:url({{ asset('front/img/1280x852.png') }});"></div>
        ...
        <div class="container">
            ...
            <div class="row row-wrap" data-gutter="60">
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="AMaze" />
                        </header>
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Chiara" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Bubbles" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Gamer Chick" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Afro" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Me with the Uke" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Andrea" />
                        </header>
                        <div class="thumb-caption">
                ...
                <div class="col-md-3">
                    <div class="thumb text-center">
                        <header class="thumb-header">
                            <img class="round" src="{{ asset('front/img/300x300.png') }}" alt="Image Alternative text" title="Spidy" />
                        </header>
                        <div class="thumb-caption">
                            <h5 class="thumb-title">Oliver Ross</h5>
                            <p class="thumb-meta text-small">Office Manager</p>
        ...
        <div class="row row-no-gutter">
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="The Big Showoff-Take 2" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="Gaviota en el Top" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="Street" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="Playstation controller" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="Branding  iPad Interactive Design" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="Old No7" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="Going out tonight" />
            </div>
            <div class="col-md-3">
                <img src="{{ asset('front/img/800x600.png') }}" alt="Image Alternative text" title="me" />
            </div>
        </div>
        <div class="container">
        </div>
