...
/**
 * Clase overrideada para corregir problema en donde el tipado de fecha de los atributos expiration_date_from y expiration_date_to enviaba un formato de fecha inválido.
 * 
 ...
 */
class Preference extends \MercadoPago\Entity
{
    /**
